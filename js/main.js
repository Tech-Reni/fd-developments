...
(function() {
  ...
  function hideLoader() {
    ...
    // Remove the overlay from the DOM once the fade-out has finished so the
    // logo/bar can never be left painted over the page (returns, screenshots).
  ...
  // Failsafe: a hanging asset must never leave the loading screen up.
