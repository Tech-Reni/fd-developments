...
(function() {
  ...
  const projectData = {
    1: {
      ...
      images: [
        'img/abuja-duplex.jpg',
        'img/nigeria-modern-home-2.jpg',
        'img/nigeria-living-room.jpg'
      ],
      area: 850,
      bedrooms: 5,
      year: 2024
    ...
    2: {
      ...
      images: [
        'img/ibadan-modern-home.jpg',
        'img/nigeria-kitchen.jpg',
        'img/nigeria-luxury-bedroom.jpg'
      ],
      area: 620,
      bedrooms: 4,
      year: 2023
    ...
    3: {
      ...
      images: [
        'img/ikoyi-office-tower.jpg',
        'img/victoria-island-bank-tower.jpg',
        'img/lagos-island-cityscape.jpg'
      ],
      area: 2500,
      bedrooms: 0,
      year: 2022
    ...
    4: {
      ...
      images: [
        'img/lagos-riverside-homes.jpg',
        'img/lagos-highrise-apartments.jpg',
        'img/nigeria-living-room.jpg'
      ],
      area: 180,
      bedrooms: 3,
    ...
    5: {
      ...
      images: [
        'img/nigeria-pop-ceiling.jpg',
        'img/nigeria-kitchen.jpg',
        'img/nigeria-bathroom.jpg'
      ],
      area: 450,
      bedrooms: 4,
      year: 2024
    ...
    6: {
      ...
      images: [
        'img/eko-atlantic-lagos.jpg',
        'img/nigeria-luxury-bedroom.jpg',
        'img/victoria-island-lagos.jpg'
      ],
      area: 1200,
      bedrooms: 6,
      year: 2026
    ...
    7: {
      ...
      images: [
        'img/abuja-building-construction.jpg',
        'img/abuja-city-building.jpg',
        'img/ikoyi-office-tower.jpg'
      ],
      area: 3000,
      bedrooms: 0,
    ...
    8: {
      ...
      images: [
        'img/nigeria-land-clearing.jpg',
        'img/lagos-estate-gate.jpg',
        'img/lagos-construction-workers.jpg'
      ],
      area: 500,
      bedrooms: 4,
      year: 2026
    ...
    9: {
      ...
      images: [
        'img/lagos-1004-apartments.jpg',
        'img/lagos-highrise-apartments.jpg',
        'img/nigeria-tiles-abuja.jpg'
      ],
      area: 120,
      bedrooms: 2,
      year: 2026
